...
namespace REST\v1\Production\ACL\ProductionStatus\Filter;

use Zend\InputFilter\InputFilter;
use Zend\InputFilter\InputFilterInterface;
use Zend\InputFilter\InputFilterAwareInterface;

class ProductionStatusFilter implements InputFilterAwareInterface
{
	...
	public function getInputFilter()
	{
        if(!$this->inputFilter)
        {
            ...
            // idproductionstatus: DataType = INT, PK = true, NN = true, AI = true
            ...
            // productionstatus_name: DataType = VARCHAR(245), NN = true
            $inputFilter->add(array(
