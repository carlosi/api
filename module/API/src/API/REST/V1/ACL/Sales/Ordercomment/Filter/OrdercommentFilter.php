...
/**
 * Class OrdercommentFilter
 * @package API\REST\V1\ACL\Sales\Ordercomment\Filter
 */
class OrdercommentFilter implements InputFilterAwareInterface
{
    /**
     * @var
     */
    ...
    public function getInputFilter()
    {
        if (!$this->inputFilter) {
            ...
            // idordercomment: DataType = INT, PK = true, NN = true, AI = true
            ...
            // ordercomment_note: DataType = TEXT, NN = true
            $inputFilter->add(array(
            ...
            // ordercomment_date: DataType = DATETIME, NN = true
            $inputFilter->add(array(
