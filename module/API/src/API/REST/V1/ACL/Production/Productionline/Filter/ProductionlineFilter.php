 ...
 */
class ProductionlineFilter implements InputFilterAwareInterface
{
    /**
     * @var
     */
    ...
    public function getInputFilter()
	{
        if(!$this->inputFilter)
        {
            ...
            // idproductionline: DataType = INT, PK = true, NN = true, AI = true
            ...
            // productionline_name: DataType = VARCHAR(245), NN = true
            $inputFilter->add(array(
