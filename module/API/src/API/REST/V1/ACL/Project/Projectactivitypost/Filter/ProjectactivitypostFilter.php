...
/**
 * Class ProjectactivitypostFilter
 * @package API\REST\V1\ACL\Proyect\Projectactivitypost\Filter
 */
class ProjectactivitypostFilter implements InputFilterAwareInterface
{
    /**
     * @var
     */
    ...
    public function getInputFilter()
    {
        if(!$this->inputFilter)
        {
            ...
            // idprojectactivitypost: DataType = INT, PK = true, NN = true, AI = true
            ...
            // projectactivitypost_text: DataType = TEXT, NN = false
            $inputFilter->add(array(
