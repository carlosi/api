...
class MarketingcampaignFilter implements InputFilterAwareInterface
{
    ...
    public function getInputFilter()
    {
        if (!$this->inputFilter) {
            ...
            // idmarketingcampaign: DataType = INT, PK = true, NN = true, AI = true
            ...
            // idmarketingchannel: DataType = INT, NN = true
            $inputFilter->add(array(
                'name'     => 'idmarketingchannel',
                'required' => true,
                'filters'  => array(
            ...
            // marketingcampaign_name: DataType = TEXT, NN = true
            $inputFilter->add(array(
