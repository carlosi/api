...
//==============FORMS================
use Company\ACL\ClientComment\Form\ClientCommentFormPostPut;
use Company\ACL\Client\Form\ClientFormGET;
use Company\ACL\ClientComment\Form\ClientCommentFormGET;
//==============FILTERS==============
use Company\ACL\ClientComment\Filter\ClientCommentFilterPostPut;
//=============PROPEL===============
use Clientcomment;
use ClientQuery;
use BasePeer;
                ...
                if($this->getQuery()->create()->useClientQuery()->filterByIdCompany($idCompany)->endUse()->filterByIdclientcomment($id)->exists()){
                    ...
                    if($clientcommentForm->isValid()){
                        ...
                        if($clientcomment->isModified()){
                            ...
                            $bodyResponse = array(
                                "_links" => array(
                                    'self' => WEBSITE_API.'/'. $this->table.'/'.$clientcomment->getIdClient(),
                                ),
                            );
