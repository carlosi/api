...
use Company\ACL\ClientAddress\Form\ClientAddressFormPostPut;
//==============FILTERS==============
use Company\ACL\ClientAddress\Filter\ClientAddressFilterPostPut;
//=============PROPEL===============
                ...
                if($this->getQuery()->create()->useClientQuery()->filterByIdCompany($idCompany)->endUse()->filterByIdclientaddress($id)->exists()){
                    ...
                    if($clientaddressForm->isValid()){
                        ...
                        if($clientaddress->isModified()){
                            ...
                            $bodyResponse = array(
                                "_links" => array(
                                    'self' => WEBSITE_API.'/'. $this->table.'/'.$clientaddress->getIdClient(),
                                ),
                            );
