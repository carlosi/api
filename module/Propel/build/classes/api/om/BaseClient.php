...
abstract class BaseClient extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the client_firstname field.
     * @var        string
     */
    protected $client_firstname;

    /**
     * The value for the client_lastname field.
     * @var        string
     */
    protected $client_lastname;
    ...
    /**
     * @var        PropelObjectCollection|Clientaddressship[] Collection to store aggregation of Clientaddressship objects.
     */
    protected $collClientaddressships;
    protected $collClientaddressshipsPartial;
    ...
    /**
     * @var        PropelObjectCollection|Triggerprospection[] Collection to store aggregation of Triggerprospection objects.
     */
    protected $collTriggerprospections;
    protected $collTriggerprospectionsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $clientaddressshipsScheduledForDeletion = null;
     ...
     * @var		PropelObjectCollection
     */
    protected $triggerprospectionsScheduledForDeletion = null;
    ...
    /**
     * Get the [client_firstname] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [client_lastname] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [client_firstname] column.
     *
     * @param  string $v new value
     * @return Client The current object (for fluent API support)
     */
    public function setClientFirstname($v)
    {
        ...
        if ($this->client_firstname !== $v) {
            $this->client_firstname = $v;
            $this->modifiedColumns[] = ClientPeer::CLIENT_FIRSTNAME;
        }
    ...
    /**
     * Set the value of [client_lastname] column.
     *
     * @param  string $v new value
     * @return Client The current object (for fluent API support)
     */
    public function setClientLastname($v)
    {
        ...
        if ($this->client_lastname !== $v) {
            $this->client_lastname = $v;
            $this->modifiedColumns[] = ClientPeer::CLIENT_LASTNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->client_firstname = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->client_lastname = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->client_email = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->client_email2 = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->client_password = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->client_cellular = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->client_phone = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->client_language = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->client_status = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->client_type = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->resetModified();
            ...
            return $startcol + 14; // 14 = ClientPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collClientaddressships = null;
            ...
            $this->collTriggerprospections = null;
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->clientaddressshipsScheduledForDeletion !== null) {
                if (!$this->clientaddressshipsScheduledForDeletion->isEmpty()) {
                    ClientaddressshipQuery::create()
                        ->filterByPrimaryKeys($this->clientaddressshipsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->clientaddressshipsScheduledForDeletion = null;
                }
            }

            if ($this->collClientaddressships !== null) {
                foreach ($this->collClientaddressships as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
            ...
            if ($this->triggerprospectionsScheduledForDeletion !== null) {
                if (!$this->triggerprospectionsScheduledForDeletion->isEmpty()) {
                    TriggerprospectionQuery::create()
                        ->filterByPrimaryKeys($this->triggerprospectionsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->triggerprospectionsScheduledForDeletion = null;
                }
            }

            if ($this->collTriggerprospections !== null) {
                foreach ($this->collTriggerprospections as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientPeer::CLIENT_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`client_firstname`';
        }
        if ($this->isColumnModified(ClientPeer::CLIENT_LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`client_lastname`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`client_firstname`':
                        $stmt->bindValue($identifier, $this->client_firstname, PDO::PARAM_STR);
                        break;
                    case '`client_lastname`':
                        $stmt->bindValue($identifier, $this->client_lastname, PDO::PARAM_STR);
                        break;
                    case '`client_email`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getClientFirstname();
                break;
            case 5:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getClientFirstname(),
            $keys[5] => $this->getClientLastname(),
            $keys[6] => $this->getClientEmail(),
            $keys[7] => $this->getClientEmail2(),
            $keys[8] => $this->getClientPassword(),
            $keys[9] => $this->getClientCellular(),
            $keys[10] => $this->getClientPhone(),
            $keys[11] => $this->getClientLanguage(),
            $keys[12] => $this->getClientStatus(),
            $keys[13] => $this->getClientType(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collClientaddressships) {
                $result['Clientaddressships'] = $this->collClientaddressships->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
            ...
            if (null !== $this->collTriggerprospections) {
                $result['Triggerprospections'] = $this->collTriggerprospections->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setClientFirstname($value);
                break;
            case 5:
                $this->setClientLastname($value);
                break;
            case 6:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setClientFirstname($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setClientLastname($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setClientEmail($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setClientEmail2($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setClientPassword($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setClientCellular($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setClientPhone($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setClientLanguage($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setClientStatus($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setClientType($arr[$keys[13]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientPeer::CLIENT_FIRSTNAME)) $criteria->add(ClientPeer::CLIENT_FIRSTNAME, $this->client_firstname);
        if ($this->isColumnModified(ClientPeer::CLIENT_LASTNAME)) $criteria->add(ClientPeer::CLIENT_LASTNAME, $this->client_lastname);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setClientFirstname($this->getClientFirstname());
        $copyObj->setClientLastname($this->getClientLastname());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getClientaddressships() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addClientaddressship($relObj->copy($deepCopy));
                }
            }
            ...
            foreach ($this->getTriggerprospections() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addTriggerprospection($relObj->copy($deepCopy));
                }
            }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('Clientaddressship' == $relationName) {
            $this->initClientaddressships();
        }
        ...
        if ('Triggerprospection' == $relationName) {
            $this->initTriggerprospections();
        }
    }
    ...
    /**
     * Clears out the collClientaddressships collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Client The current object (for fluent API support)
     * @see        addClientaddressships()
     */
    public function clearClientaddressships()
    {
        $this->collClientaddressships = null; // important to set this to null since that means it is uninitialized
        $this->collClientaddressshipsPartial = null;

        return $this;
    }

    /**
     * reset is the collClientaddressships collection loaded partially
     *
     * @return void
     */
    public function resetPartialClientaddressships($v = true)
    {
        $this->collClientaddressshipsPartial = $v;
    }

    /**
     * Initializes the collClientaddressships collection.
     *
     * By default this just sets the collClientaddressships collection to an empty array (like clearcollClientaddressships());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initClientaddressships($overrideExisting = true)
    {
        if (null !== $this->collClientaddressships && !$overrideExisting) {
            return;
        }
        $this->collClientaddressships = new PropelObjectCollection();
        $this->collClientaddressships->setModel('Clientaddressship');
    }

    /**
     * Gets an array of Clientaddressship objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Clientaddressship[] List of Clientaddressship objects
     * @throws PropelException
     */
    public function getClientaddressships($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collClientaddressshipsPartial && !$this->isNew();
        if (null === $this->collClientaddressships || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collClientaddressships) {
                // return empty collection
                $this->initClientaddressships();
            } else {
                $collClientaddressships = ClientaddressshipQuery::create(null, $criteria)
                    ->filterByClient($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collClientaddressshipsPartial && count($collClientaddressships)) {
                      $this->initClientaddressships(false);

                      foreach ($collClientaddressships as $obj) {
                        if (false == $this->collClientaddressships->contains($obj)) {
                          $this->collClientaddressships->append($obj);
                        }
                      }

                      $this->collClientaddressshipsPartial = true;
                    }

                    $collClientaddressships->getInternalIterator()->rewind();

                    return $collClientaddressships;
                }

                if ($partial && $this->collClientaddressships) {
                    foreach ($this->collClientaddressships as $obj) {
                        if ($obj->isNew()) {
                            $collClientaddressships[] = $obj;
                        }
                    }
                }

                $this->collClientaddressships = $collClientaddressships;
                $this->collClientaddressshipsPartial = false;
            }
        }

        return $this->collClientaddressships;
    }

    /**
     * Sets a collection of Clientaddressship objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $clientaddressships A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Client The current object (for fluent API support)
     */
    public function setClientaddressships(PropelCollection $clientaddressships, PropelPDO $con = null)
    {
        $clientaddressshipsToDelete = $this->getClientaddressships(new Criteria(), $con)->diff($clientaddressships);


        $this->clientaddressshipsScheduledForDeletion = $clientaddressshipsToDelete;

        foreach ($clientaddressshipsToDelete as $clientaddressshipRemoved) {
            $clientaddressshipRemoved->setClient(null);
        }

        $this->collClientaddressships = null;
        foreach ($clientaddressships as $clientaddressship) {
            $this->addClientaddressship($clientaddressship);
        }

        $this->collClientaddressships = $clientaddressships;
        $this->collClientaddressshipsPartial = false;
    ...
    /**
     * Returns the number of related Clientaddressship objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Clientaddressship objects.
     * @throws PropelException
     */
    public function countClientaddressships(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collClientaddressshipsPartial && !$this->isNew();
        if (null === $this->collClientaddressships || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collClientaddressships) {
            ...
            if ($partial && !$criteria) {
                return count($this->getClientaddressships());
            }
            $query = ClientaddressshipQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collClientaddressships);
    }

    /**
     * Method called to associate a Clientaddressship object to this object
     * through the Clientaddressship foreign key attribute.
     *
     * @param    Clientaddressship $l Clientaddressship
     * @return Client The current object (for fluent API support)
     */
    public function addClientaddressship(Clientaddressship $l)
    {
        if ($this->collClientaddressships === null) {
            $this->initClientaddressships();
            $this->collClientaddressshipsPartial = true;
        ...
        if (!in_array($l, $this->collClientaddressships->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddClientaddressship($l);

            if ($this->clientaddressshipsScheduledForDeletion and $this->clientaddressshipsScheduledForDeletion->contains($l)) {
                $this->clientaddressshipsScheduledForDeletion->remove($this->clientaddressshipsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	Clientaddressship $clientaddressship The clientaddressship object to add.
     */
    protected function doAddClientaddressship($clientaddressship)
    {
        $this->collClientaddressships[]= $clientaddressship;
        $clientaddressship->setClient($this);
    }

    /**
     * @param	Clientaddressship $clientaddressship The clientaddressship object to remove.
     * @return Client The current object (for fluent API support)
     */
    public function removeClientaddressship($clientaddressship)
    {
        if ($this->getClientaddressships()->contains($clientaddressship)) {
            $this->collClientaddressships->remove($this->collClientaddressships->search($clientaddressship));
            if (null === $this->clientaddressshipsScheduledForDeletion) {
                $this->clientaddressshipsScheduledForDeletion = clone $this->collClientaddressships;
                $this->clientaddressshipsScheduledForDeletion->clear();
            }
            $this->clientaddressshipsScheduledForDeletion[]= clone $clientaddressship;
            $clientaddressship->setClient(null);
        }
    ...
    /**
     * Clears out the collTriggerprospections collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Client The current object (for fluent API support)
     * @see        addTriggerprospections()
     */
    public function clearTriggerprospections()
    {
        $this->collTriggerprospections = null; // important to set this to null since that means it is uninitialized
        $this->collTriggerprospectionsPartial = null;

        return $this;
    }

    /**
     * reset is the collTriggerprospections collection loaded partially
     *
     * @return void
     */
    public function resetPartialTriggerprospections($v = true)
    {
        $this->collTriggerprospectionsPartial = $v;
    }

    /**
     * Initializes the collTriggerprospections collection.
     *
     * By default this just sets the collTriggerprospections collection to an empty array (like clearcollTriggerprospections());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initTriggerprospections($overrideExisting = true)
    {
        if (null !== $this->collTriggerprospections && !$overrideExisting) {
            return;
        }
        $this->collTriggerprospections = new PropelObjectCollection();
        $this->collTriggerprospections->setModel('Triggerprospection');
    }

    /**
     * Gets an array of Triggerprospection objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Triggerprospection[] List of Triggerprospection objects
     * @throws PropelException
     */
    public function getTriggerprospections($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collTriggerprospectionsPartial && !$this->isNew();
        if (null === $this->collTriggerprospections || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTriggerprospections) {
                // return empty collection
                $this->initTriggerprospections();
            } else {
                $collTriggerprospections = TriggerprospectionQuery::create(null, $criteria)
                    ->filterByClient($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collTriggerprospectionsPartial && count($collTriggerprospections)) {
                      $this->initTriggerprospections(false);

                      foreach ($collTriggerprospections as $obj) {
                        if (false == $this->collTriggerprospections->contains($obj)) {
                          $this->collTriggerprospections->append($obj);
                        }
                      }

                      $this->collTriggerprospectionsPartial = true;
                    }

                    $collTriggerprospections->getInternalIterator()->rewind();

                    return $collTriggerprospections;
                }

                if ($partial && $this->collTriggerprospections) {
                    foreach ($this->collTriggerprospections as $obj) {
                        if ($obj->isNew()) {
                            $collTriggerprospections[] = $obj;
                        }
                    }
                }

                $this->collTriggerprospections = $collTriggerprospections;
                $this->collTriggerprospectionsPartial = false;
            }
        }

        return $this->collTriggerprospections;
    }

    /**
     * Sets a collection of Triggerprospection objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $triggerprospections A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Client The current object (for fluent API support)
     */
    public function setTriggerprospections(PropelCollection $triggerprospections, PropelPDO $con = null)
    {
        $triggerprospectionsToDelete = $this->getTriggerprospections(new Criteria(), $con)->diff($triggerprospections);


        $this->triggerprospectionsScheduledForDeletion = $triggerprospectionsToDelete;

        foreach ($triggerprospectionsToDelete as $triggerprospectionRemoved) {
            $triggerprospectionRemoved->setClient(null);
        }

        $this->collTriggerprospections = null;
        foreach ($triggerprospections as $triggerprospection) {
            $this->addTriggerprospection($triggerprospection);
        }

        $this->collTriggerprospections = $triggerprospections;
        $this->collTriggerprospectionsPartial = false;
    ...
    /**
     * Returns the number of related Triggerprospection objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Triggerprospection objects.
     * @throws PropelException
     */
    public function countTriggerprospections(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collTriggerprospectionsPartial && !$this->isNew();
        if (null === $this->collTriggerprospections || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collTriggerprospections) {
            ...
            if ($partial && !$criteria) {
                return count($this->getTriggerprospections());
            }
            $query = TriggerprospectionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collTriggerprospections);
    }

    /**
     * Method called to associate a Triggerprospection object to this object
     * through the Triggerprospection foreign key attribute.
     *
     * @param    Triggerprospection $l Triggerprospection
     * @return Client The current object (for fluent API support)
     */
    public function addTriggerprospection(Triggerprospection $l)
    {
        if ($this->collTriggerprospections === null) {
            $this->initTriggerprospections();
            $this->collTriggerprospectionsPartial = true;
        ...
        if (!in_array($l, $this->collTriggerprospections->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddTriggerprospection($l);

            if ($this->triggerprospectionsScheduledForDeletion and $this->triggerprospectionsScheduledForDeletion->contains($l)) {
                $this->triggerprospectionsScheduledForDeletion->remove($this->triggerprospectionsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	Triggerprospection $triggerprospection The triggerprospection object to add.
     */
    protected function doAddTriggerprospection($triggerprospection)
    {
        $this->collTriggerprospections[]= $triggerprospection;
        $triggerprospection->setClient($this);
    }

    /**
     * @param	Triggerprospection $triggerprospection The triggerprospection object to remove.
     * @return Client The current object (for fluent API support)
     */
    public function removeTriggerprospection($triggerprospection)
    {
        if ($this->getTriggerprospections()->contains($triggerprospection)) {
            $this->collTriggerprospections->remove($this->collTriggerprospections->search($triggerprospection));
            if (null === $this->triggerprospectionsScheduledForDeletion) {
                $this->triggerprospectionsScheduledForDeletion = clone $this->collTriggerprospections;
                $this->triggerprospectionsScheduledForDeletion->clear();
            }
            $this->triggerprospectionsScheduledForDeletion[]= clone $triggerprospection;
            $triggerprospection->setClient(null);
        }
    ...
    public function clear()
    {
        ...
        $this->client_firstname = null;
        $this->client_lastname = null;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collClientaddressships) {
                foreach ($this->collClientaddressships as $o) {
                    $o->clearAllReferences($deep);
                }
            }
            ...
            if ($this->collTriggerprospections) {
                foreach ($this->collTriggerprospections as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collClientaddresss = null;
        if ($this->collClientaddressships instanceof PropelCollection) {
            $this->collClientaddressships->clearIterator();
        }
        $this->collClientaddressships = null;
        ...
        $this->collOrders = null;
        if ($this->collTriggerprospections instanceof PropelCollection) {
            $this->collTriggerprospections->clearIterator();
        }
        $this->collTriggerprospections = null;
        $this->aCompany = null;
    }
