...
abstract class BaseDepartmentPeer
{
    ...
    /** the column name for the department_type field */
    const DEPARTMENT_TYPE = 'department.department_type';

    /** The enumerated values for the department_type field */
    const DEPARTMENT_TYPE_GLOBAL = 'global';
    const DEPARTMENT_TYPE_LOCAL = 'local';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Department objects.
    ...
    protected static $enumValueSets = array(
        DepartmentPeer::DEPARTMENT_TYPE => array(
            DepartmentPeer::DEPARTMENT_TYPE_GLOBAL,
            DepartmentPeer::DEPARTMENT_TYPE_LOCAL,
        ),
    );
    ...
    {
        $toNames = DepartmentPeer::getFieldNames($toType);
        $key = isset(DepartmentPeer::$fieldKeys[$fromType][$name]) ? DepartmentPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(DepartmentPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, DepartmentPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return DepartmentPeer::$fieldNames[$type];
    }
    ...
    {
      return DepartmentPeer::$enumValueSets;
    }
    ...
    {
        $valueSets = DepartmentPeer::getValueSets();
    ...
    {
        $values = DepartmentPeer::getValueSet($colname);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(DepartmentPeer::DATABASE_NAME); // Set the correct dbName
     ...
     *
     * @param Department $obj A Department object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIddepartment();
            } // if key === null
            DepartmentPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Department) {
                $key = (string) $value->getIddepartment();
            ...
            unset(DepartmentPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(DepartmentPeer::$instances[$key])) {
                return DepartmentPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (DepartmentPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        DepartmentPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to department
    ...
    {
        $key = DepartmentPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = DepartmentPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + DepartmentPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = DepartmentPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(DepartmentPeer::DATABASE_NAME)->getTable(DepartmentPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseDepartmentPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseDepartmentPeer::TABLE_NAME)) {
    ...
    {
        return DepartmentPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(DepartmentPeer::IDDEPARTMENT) && $criteria->keyContainsValue(DepartmentPeer::IDDEPARTMENT) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Department or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(DepartmentPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(DepartmentPeer::IDDEPARTMENT);
            $value = $criteria->remove(DepartmentPeer::IDDEPARTMENT);
            if ($value) {
                $selectCriteria->add(DepartmentPeer::IDDEPARTMENT, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(DepartmentPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $affectedRows += BasePeer::doDeleteAll(DepartmentPeer::TABLE_NAME, $con, DepartmentPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            DepartmentPeer::clearInstancePool();
            DepartmentPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(DepartmentPeer::IDDEPARTMENT, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += DepartmentPeer::doOnDeleteCascade($c, $con);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(DepartmentPeer::DATABASE_NAME);
        $criteria->add(DepartmentPeer::IDDEPARTMENT, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(DepartmentPeer::DATABASE_NAME);
            $criteria->add(DepartmentPeer::IDDEPARTMENT, $pks, Criteria::IN);
...
//
BaseDepartmentPeer::buildTableMap();
