...
/**
 * Base class that represents a row from the 'projectactivityuser' table.
 *
 *
 *
 * @package    propel.generator.api.om
 */
abstract class BaseProjectactivityuser extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectactivityuserPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectactivityuserPeer
     */
    ...
    public function setIdprojectactivity($v)
    {
        ...
        if ($this->idprojectactivity !== $v) {
            ...
            $this->modifiedColumns[] = ProjectactivityuserPeer::IDPROJECTACTIVITY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProjectactivityuserPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Projectactivityuser object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectactivityuserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectactivityuserQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectactivityuserPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectactivityuserPeer::IDPROJECTACTIVITY)) {
            $modifiedColumns[':p' . $index++]  = '`idprojectactivity`';
        }

        $sql = sprintf(
            'INSERT INTO `projectactivityuser` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectactivityuserPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectactivityuserPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Projectactivityuser'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of Projectactivityuser (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Projectactivityuser Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectactivityuserPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectactivityuserPeer();
        }
    ...
    public function getProjectactivity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProjectactivity === null && ($this->idprojectactivity !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjectactivity->addProjectactivityusers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectactivityuserPeer::DEFAULT_STRING_FORMAT);
    }
