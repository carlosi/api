 ...
 *
 * @method MarketingcampaignclientQuery leftJoinMarketingprospection($relationAlias = null) Adds a LEFT JOIN clause to the query using the Marketingprospection relation
 * @method MarketingcampaignclientQuery rightJoinMarketingprospection($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Marketingprospection relation
 * @method MarketingcampaignclientQuery innerJoinMarketingprospection($relationAlias = null) Adds a INNER JOIN clause to the query using the Marketingprospection relation
 *
...
abstract class BaseMarketingcampaignclientQuery extends ModelCriteria
{
     ...
     *
     * @param   Marketingprospection|PropelObjectCollection $marketingprospection  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 MarketingcampaignclientQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
    ...
    public function filterByMarketingprospection($marketingprospection, $comparison = null)
    {
        if ($marketingprospection instanceof Marketingprospection) {
            return $this
                ->addUsingAlias(MarketingcampaignclientPeer::IDMARKETINGCAMPAIGNCLIENT, $marketingprospection->getIdmarketingcampaignclient(), $comparison);
        } elseif ($marketingprospection instanceof PropelObjectCollection) {
            return $this
                ->useMarketingprospectionQuery()
                ->filterByPrimaryKeys($marketingprospection->getPrimaryKeys())
                ->endUse();
        } else {
