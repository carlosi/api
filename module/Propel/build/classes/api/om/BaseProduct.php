...
abstract class BaseProduct extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the property_array field.
     * @var        string
     */
    ...
    /**
     * Get the [property_array] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [property_array] column.
     *
     * @param  string $v new value
     * @return Product The current object (for fluent API support)
     */
    public function setPropertyArray($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->property_array !== $v) {
            $this->property_array = $v;
            $this->modifiedColumns[] = ProductPeer::PROPERTY_ARRAY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->property_array = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->product_status = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductPeer::PROPERTY_ARRAY)) {
            $modifiedColumns[':p' . $index++]  = '`property_array`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idproductmain`':
                        ...
                        break;
                    case '`property_array`':
                        $stmt->bindValue($identifier, $this->property_array, PDO::PARAM_STR);
                        break;
                    case '`product_status`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getPropertyArray(),
            $keys[3] => $this->getProductStatus(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPropertyArray($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setProductStatus($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductPeer::PROPERTY_ARRAY)) $criteria->add(ProductPeer::PROPERTY_ARRAY, $this->property_array);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPropertyArray($this->getPropertyArray());
