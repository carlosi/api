...
abstract class BaseOrderPeer
{
    ...
    /** the column name for the order_paymentmode field */
    const ORDER_PAYMENTMODE = 'order.order_paymentmode';
    ...
    protected static $enumValueSets = array(
        ...
        OrderPeer::ORDER_PAYMENT => array(
            ...
            OrderPeer::ORDER_PAYMENT_UNPAID,
        ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(OrderPeer::IDORDER);
    ...
    public static function doCountJoinBranch(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::IDBRANCH, BranchPeer::IDBRANCH, $join_behavior);
    ...
    public static function doCountJoinClient(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::IDCLIENT, ClientPeer::IDCLIENT, $join_behavior);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (Branch)
                $obj2->addOrder($obj1);
    ...
    public static function doSelectJoinAllExceptBranch(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = OrderPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (Client)
                $obj2->addOrder($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(OrderPeer::IDORDER) && $criteria->keyContainsValue(OrderPeer::IDORDER) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(OrderPeer::IDORDER);
            $value = $criteria->remove(OrderPeer::IDORDER);
            if ($value) {
                $selectCriteria->add(OrderPeer::IDORDER, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(OrderPeer::IDORDER, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(BankordertransactionPeer::IDORDER, $obj->getIdorder());
            ...
            $criteria->add(MxtaxdocumentPeer::IDORDER, $obj->getIdorder());
            ...
            $criteria->add(OrdercommentPeer::IDORDER, $obj->getIdorder());
            ...
            $criteria->add(OrderfilePeer::IDORDER, $obj->getIdorder());
            ...
            $criteria->add(OrderitemPeer::IDORDER, $obj->getIdorder());
            $affectedRows += OrderitemPeer::doDelete($criteria, $con);

            // delete related Orderrecord objects
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(OrderPeer::DATABASE_NAME);
        $criteria->add(OrderPeer::IDORDER, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(OrderPeer::DATABASE_NAME);
            $criteria->add(OrderPeer::IDORDER, $pks, Criteria::IN);
