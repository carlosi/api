...
abstract class BaseBranch extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the branch_timezone field.
     * @var        string
     */
    protected $branch_timezone;
     ...
     */
    protected $collBranchdepartments;
    protected $collBranchdepartmentsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $branchdepartmentsScheduledForDeletion = null;
    ...
    /**
     * Get the [branch_timezone] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [branch_timezone] column.
     *
     * @param  string $v new value
     * @return Branch The current object (for fluent API support)
     */
    public function setBranchTimezone($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->branch_timezone !== $v) {
            $this->branch_timezone = $v;
            $this->modifiedColumns[] = BranchPeer::BRANCH_TIMEZONE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->branch_timezone = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->branch_iso_codecountry = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->branch_address = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->branch_address2 = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->branch_city = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->branch_state = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->branch_zipcode = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->resetModified();
            ...
            return $startcol + 10; // 10 = BranchPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->branchdepartmentsScheduledForDeletion !== null) {
                if (!$this->branchdepartmentsScheduledForDeletion->isEmpty()) {
                    BranchdepartmentQuery::create()
                        ->filterByPrimaryKeys($this->branchdepartmentsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->branchdepartmentsScheduledForDeletion = null;
                }
            }

            if ($this->collBranchdepartments !== null) {
                foreach ($this->collBranchdepartments as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BranchPeer::BRANCH_TIMEZONE)) {
            $modifiedColumns[':p' . $index++]  = '`branch_timezone`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`branch_name`':
                        ...
                        break;
                    case '`branch_timezone`':
                        $stmt->bindValue($identifier, $this->branch_timezone, PDO::PARAM_STR);
                        break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getBranchTimezone(),
            $keys[4] => $this->getBranchIsoCodecountry(),
            $keys[5] => $this->getBranchAddress(),
            $keys[6] => $this->getBranchAddress2(),
            $keys[7] => $this->getBranchCity(),
            $keys[8] => $this->getBranchState(),
            $keys[9] => $this->getBranchZipcode(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setBranchTimezone($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setBranchIsoCodecountry($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setBranchAddress($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setBranchAddress2($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setBranchCity($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setBranchState($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setBranchZipcode($arr[$keys[9]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BranchPeer::BRANCH_TIMEZONE)) $criteria->add(BranchPeer::BRANCH_TIMEZONE, $this->branch_timezone);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBranchTimezone($this->getBranchTimezone());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getBranchdepartments() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addBranchdepartment($relObj->copy($deepCopy));
                }
            }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('Branchdepartment' == $relationName) {
            $this->initBranchdepartments();
        }
    ...
    public function setBranchUserAcls(PropelCollection $branchUserAcls, PropelPDO $con = null)
    {
        ...
        foreach ($branchUserAclsToDelete as $branchUserAclRemoved) {
            $branchUserAclRemoved->setBranch(null);
        }
     ...
     * @return PropelObjectCollection|BranchUserAcl[] List of BranchUserAcl objects
     */
    public function getBranchUserAclsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BranchUserAclQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collBranchdepartments collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Branch The current object (for fluent API support)
     * @see        addBranchdepartments()
     */
    public function clearBranchdepartments()
    {
        $this->collBranchdepartments = null; // important to set this to null since that means it is uninitialized
        $this->collBranchdepartmentsPartial = null;

        return $this;
    }

    /**
     * reset is the collBranchdepartments collection loaded partially
     *
     * @return void
     */
    public function resetPartialBranchdepartments($v = true)
    {
        $this->collBranchdepartmentsPartial = $v;
    }

    /**
     * Initializes the collBranchdepartments collection.
     *
     * By default this just sets the collBranchdepartments collection to an empty array (like clearcollBranchdepartments());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initBranchdepartments($overrideExisting = true)
    {
        if (null !== $this->collBranchdepartments && !$overrideExisting) {
            return;
        }
        $this->collBranchdepartments = new PropelObjectCollection();
        $this->collBranchdepartments->setModel('Branchdepartment');
    }

    /**
     * Gets an array of Branchdepartment objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Branchdepartment[] List of Branchdepartment objects
     * @throws PropelException
     */
    public function getBranchdepartments($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collBranchdepartmentsPartial && !$this->isNew();
        if (null === $this->collBranchdepartments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBranchdepartments) {
                // return empty collection
                $this->initBranchdepartments();
            } else {
                $collBranchdepartments = BranchdepartmentQuery::create(null, $criteria)
                    ->filterByBranch($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collBranchdepartmentsPartial && count($collBranchdepartments)) {
                      $this->initBranchdepartments(false);

                      foreach ($collBranchdepartments as $obj) {
                        if (false == $this->collBranchdepartments->contains($obj)) {
                          $this->collBranchdepartments->append($obj);
                        }
                      }

                      $this->collBranchdepartmentsPartial = true;
                    }

                    $collBranchdepartments->getInternalIterator()->rewind();

                    return $collBranchdepartments;
                }

                if ($partial && $this->collBranchdepartments) {
                    foreach ($this->collBranchdepartments as $obj) {
                        if ($obj->isNew()) {
                            $collBranchdepartments[] = $obj;
                        }
                    }
                }

                $this->collBranchdepartments = $collBranchdepartments;
                $this->collBranchdepartmentsPartial = false;
            }
        }

        return $this->collBranchdepartments;
    }

    /**
     * Sets a collection of Branchdepartment objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $branchdepartments A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Branch The current object (for fluent API support)
     */
    public function setBranchdepartments(PropelCollection $branchdepartments, PropelPDO $con = null)
    {
        $branchdepartmentsToDelete = $this->getBranchdepartments(new Criteria(), $con)->diff($branchdepartments);


        $this->branchdepartmentsScheduledForDeletion = $branchdepartmentsToDelete;

        foreach ($branchdepartmentsToDelete as $branchdepartmentRemoved) {
            $branchdepartmentRemoved->setBranch(null);
        }

        $this->collBranchdepartments = null;
        foreach ($branchdepartments as $branchdepartment) {
            $this->addBranchdepartment($branchdepartment);
        }

        $this->collBranchdepartments = $branchdepartments;
        $this->collBranchdepartmentsPartial = false;
    ...
    /**
     * Returns the number of related Branchdepartment objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Branchdepartment objects.
     * @throws PropelException
     */
    public function countBranchdepartments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collBranchdepartmentsPartial && !$this->isNew();
        if (null === $this->collBranchdepartments || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collBranchdepartments) {
            ...
            if ($partial && !$criteria) {
                return count($this->getBranchdepartments());
            }
            $query = BranchdepartmentQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collBranchdepartments);
    }

    /**
     * Method called to associate a Branchdepartment object to this object
     * through the Branchdepartment foreign key attribute.
     *
     * @param    Branchdepartment $l Branchdepartment
     * @return Branch The current object (for fluent API support)
     */
    public function addBranchdepartment(Branchdepartment $l)
    {
        if ($this->collBranchdepartments === null) {
            $this->initBranchdepartments();
            $this->collBranchdepartmentsPartial = true;
        ...
        if (!in_array($l, $this->collBranchdepartments->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddBranchdepartment($l);

            if ($this->branchdepartmentsScheduledForDeletion and $this->branchdepartmentsScheduledForDeletion->contains($l)) {
                $this->branchdepartmentsScheduledForDeletion->remove($this->branchdepartmentsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	Branchdepartment $branchdepartment The branchdepartment object to add.
     */
    protected function doAddBranchdepartment($branchdepartment)
    {
        $this->collBranchdepartments[]= $branchdepartment;
        $branchdepartment->setBranch($this);
    }

    /**
     * @param	Branchdepartment $branchdepartment The branchdepartment object to remove.
     * @return Branch The current object (for fluent API support)
     */
    public function removeBranchdepartment($branchdepartment)
    {
        if ($this->getBranchdepartments()->contains($branchdepartment)) {
            $this->collBranchdepartments->remove($this->collBranchdepartments->search($branchdepartment));
            if (null === $this->branchdepartmentsScheduledForDeletion) {
                $this->branchdepartmentsScheduledForDeletion = clone $this->collBranchdepartments;
                $this->branchdepartmentsScheduledForDeletion->clear();
            }
            $this->branchdepartmentsScheduledForDeletion[]= clone $branchdepartment;
     ...
     * Otherwise if this Branch is new, it will return
     * an empty collection; or if this Branch has previously
     * been saved, it will retrieve related Branchdepartments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Branch.
     ...
     * @return PropelObjectCollection|Branchdepartment[] List of Branchdepartment objects
     */
    public function getBranchdepartmentsJoinDepartment($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BranchdepartmentQuery::create(null, $criteria);
        $query->joinWith('Department', $join_behavior);

        return $this->getBranchdepartments($query, $con);
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collBranchdepartments) {
                foreach ($this->collBranchdepartments as $o) {
                    $o->clearAllReferences($deep);
                }
            }
            if ($this->collOrders) {
        ...
        $this->collBranchUserAcls = null;
        if ($this->collBranchdepartments instanceof PropelCollection) {
            $this->collBranchdepartments->clearIterator();
        }
        $this->collBranchdepartments = null;
