...
/**
 * Base class that represents a row from the 'productionteam' table.
 *
 *
 *
 * @package    propel.generator.api.om
 */
abstract class BaseProductionteam extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProductionteamPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductionteamPeer
     */
    ...
    /**
     * The value for the productionteam_name field.
     * @var        string
     */
    protected $productionteam_name;
    ...
    /**
     * Get the [productionteam_name] column value.
     *
     * @return string
     */
    public function getProductionteamName()
    {

        return $this->productionteam_name;
    }
     ...
     * @return Productionteam The current object (for fluent API support)
     */
    public function setIdproductionteam($v)
    {
        ...
        if ($this->idproductionteam !== $v) {
            ...
            $this->modifiedColumns[] = ProductionteamPeer::IDPRODUCTIONTEAM;
        }
    ...
    public function setIdcompany($v)
    {
        ...
        if ($this->idcompany !== $v) {
            $this->idcompany = $v;
            $this->modifiedColumns[] = ProductionteamPeer::IDCOMPANY;
        }
    ...
    /**
     * Set the value of [productionteam_name] column.
     *
     * @param  string $v new value
     * @return Productionteam The current object (for fluent API support)
     */
    public function setProductionteamName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->productionteam_name !== $v) {
            $this->productionteam_name = $v;
            $this->modifiedColumns[] = ProductionteamPeer::PRODUCTIONTEAM_NAME;
        }


        return $this;
    } // setProductionteamName()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idproductionteam = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->idcompany = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->productionteam_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ProductionteamPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Productionteam object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductionteamPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductionteamQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductionteamPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductionteamPeer::IDPRODUCTIONTEAM)) {
            $modifiedColumns[':p' . $index++]  = '`idproductionteam`';
        }
        if ($this->isColumnModified(ProductionteamPeer::IDCOMPANY)) {
            $modifiedColumns[':p' . $index++]  = '`idcompany`';
        }
        if ($this->isColumnModified(ProductionteamPeer::PRODUCTIONTEAM_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`productionteam_name`';
        }

        $sql = sprintf(
            'INSERT INTO `productionteam` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idcompany`':
                        ...
                        break;
                    case '`productionteam_name`':
                        $stmt->bindValue($identifier, $this->productionteam_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductionteamPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductionteamPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getProductionteamName();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Productionteam'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Productionteam'][$this->getPrimaryKey()] = true;
        $keys = ProductionteamPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdproductionteam(),
            $keys[1] => $this->getIdcompany(),
            $keys[2] => $this->getProductionteamName(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setProductionteamName($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdproductionteam($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdcompany($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setProductionteamName($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductionteamPeer::IDPRODUCTIONTEAM)) $criteria->add(ProductionteamPeer::IDPRODUCTIONTEAM, $this->idproductionteam);
        if ($this->isColumnModified(ProductionteamPeer::IDCOMPANY)) $criteria->add(ProductionteamPeer::IDCOMPANY, $this->idcompany);
        if ($this->isColumnModified(ProductionteamPeer::PRODUCTIONTEAM_NAME)) $criteria->add(ProductionteamPeer::PRODUCTIONTEAM_NAME, $this->productionteam_name);
    ...
    {
        $criteria = new Criteria(ProductionteamPeer::DATABASE_NAME);
        $criteria->add(ProductionteamPeer::IDPRODUCTIONTEAM, $this->idproductionteam);
    ...
    /**
     * Generic method to set the primary key (idproductionteam column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdproductionteam();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Productionteam (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductionteamName($this->getProductionteamName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdproductionteam(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Productionteam Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductionteamPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductionteamPeer();
        }
    ...
    public function getCompany(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCompany === null && ($this->idcompany !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addProductionteams($this);
             */
        }
     ...
     * If this Productionteam is new, it will return
    ...
    public function setProductionorderitems(PropelCollection $productionorderitems, PropelPDO $con = null)
    {
        ...
        foreach ($productionorderitemsToDelete as $productionorderitemRemoved) {
            $productionorderitemRemoved->setProductionteam(null);
        }
    ...
    protected function doAddProductionorderitem($productionorderitem)
    {
        ...
        $productionorderitem->setProductionteam($this);
    }
    ...
    public function removeProductionorderitem($productionorderitem)
    {
        if ($this->getProductionorderitems()->contains($productionorderitem)) {
            ...
            $productionorderitem->setProductionteam(null);
        }
     ...
     * Otherwise if this Productionteam is new, it will return
     * an empty collection; or if this Productionteam has previously
     * been saved, it will retrieve related Productionorderitems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Productionteam.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setProductionusers(PropelCollection $productionusers, PropelPDO $con = null)
    {
        ...
        foreach ($productionusersToDelete as $productionuserRemoved) {
            $productionuserRemoved->setProductionteam(null);
        }
    ...
    protected function doAddProductionuser($productionuser)
    {
        ...
        $productionuser->setProductionteam($this);
    }
    ...
    public function removeProductionuser($productionuser)
    {
        if ($this->getProductionusers()->contains($productionuser)) {
            ...
            $productionuser->setProductionteam(null);
        }
     ...
     * @return PropelObjectCollection|Productionuser[] List of Productionuser objects
     */
    public function getProductionusersJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProductionuserQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ProductionteamPeer::DEFAULT_STRING_FORMAT);
    }
