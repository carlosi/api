...
/**
 * Base class that represents a row from the 'orderitem' table.
 *
 *
 *
...
abstract class BaseOrderitem extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the orderitem_note field.
     * @var        string
     */
    protected $orderitem_note;
    ...
    /**
     * Get the [orderitem_note] column value.
     *
     * @return string
     */
    ...
    public function setIdorderitem($v)
    {
        ...
        if ($this->idorderitem !== $v) {
            $this->idorderitem = $v;
            $this->modifiedColumns[] = OrderitemPeer::IDORDERITEM;
        }
    ...
    public function setIdorder($v)
    {
        ...
        if ($this->idorder !== $v) {
            $this->idorder = $v;
            $this->modifiedColumns[] = OrderitemPeer::IDORDER;
        }
    ...
    public function setIdproduct($v)
    {
        ...
        if ($this->idproduct !== $v) {
            $this->idproduct = $v;
            $this->modifiedColumns[] = OrderitemPeer::IDPRODUCT;
        }
    ...
    /**
     * Set the value of [orderitem_note] column.
     *
     * @param  string $v new value
     * @return Orderitem The current object (for fluent API support)
     */
    public function setOrderitemNote($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->orderitem_note !== $v) {
            $this->orderitem_note = $v;
            $this->modifiedColumns[] = OrderitemPeer::ORDERITEM_NOTE;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = OrderitemPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idorderitem = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->idorder = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->idproduct = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->orderitem_note = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = OrderitemPeer::IDORDERITEM;
        if (null !== $this->idorderitem) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OrderitemPeer::IDORDERITEM . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(OrderitemPeer::IDORDERITEM)) {
            $modifiedColumns[':p' . $index++]  = '`idorderitem`';
        }
        if ($this->isColumnModified(OrderitemPeer::IDORDER)) {
            $modifiedColumns[':p' . $index++]  = '`idorder`';
        }
        if ($this->isColumnModified(OrderitemPeer::IDPRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`idproduct`';
        }
        if ($this->isColumnModified(OrderitemPeer::ORDERITEM_NOTE)) {
            $modifiedColumns[':p' . $index++]  = '`orderitem_note`';
        }
        if ($this->isColumnModified(OrderitemPeer::QUANTITY)) {
            $modifiedColumns[':p' . $index++]  = '`quantity`';
        }
        if ($this->isColumnModified(OrderitemPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `orderitem` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idproduct`':
                        ...
                        break;
                    case '`orderitem_note`':
                        $stmt->bindValue($identifier, $this->orderitem_note, PDO::PARAM_STR);
                        break;
                    case '`quantity`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getIdorderitem(),
            $keys[1] => $this->getIdorder(),
            $keys[2] => $this->getIdproduct(),
            $keys[3] => $this->getOrderitemNote(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdorderitem($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdorder($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setIdproduct($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setOrderitemNote($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderitemPeer::IDORDERITEM)) $criteria->add(OrderitemPeer::IDORDERITEM, $this->idorderitem);
        if ($this->isColumnModified(OrderitemPeer::IDORDER)) $criteria->add(OrderitemPeer::IDORDER, $this->idorder);
        if ($this->isColumnModified(OrderitemPeer::IDPRODUCT)) $criteria->add(OrderitemPeer::IDPRODUCT, $this->idproduct);
        if ($this->isColumnModified(OrderitemPeer::ORDERITEM_NOTE)) $criteria->add(OrderitemPeer::ORDERITEM_NOTE, $this->orderitem_note);
        if ($this->isColumnModified(OrderitemPeer::QUANTITY)) $criteria->add(OrderitemPeer::QUANTITY, $this->quantity);
        if ($this->isColumnModified(OrderitemPeer::VALUE)) $criteria->add(OrderitemPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(OrderitemPeer::DATABASE_NAME);
        $criteria->add(OrderitemPeer::IDORDERITEM, $this->idorderitem);
    ...
    /**
     * Generic method to set the primary key (idorderitem column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdorderitem();
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setOrderitemNote($this->getOrderitemNote());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdorderitem(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function setProductionorderitems(PropelCollection $productionorderitems, PropelPDO $con = null)
    {
        ...
        foreach ($productionorderitemsToDelete as $productionorderitemRemoved) {
            $productionorderitemRemoved->setOrderitem(null);
        }
    ...
    protected function doAddProductionorderitem($productionorderitem)
    {
        ...
        $productionorderitem->setOrderitem($this);
    }
    ...
    public function removeProductionorderitem($productionorderitem)
    {
        if ($this->getProductionorderitems()->contains($productionorderitem)) {
            ...
            $productionorderitem->setOrderitem(null);
        }
