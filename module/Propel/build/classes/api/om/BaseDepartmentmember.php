...
/**
 * Base class that represents a row from the 'departmentmember' table.
 *
 *
 *
 * @package    propel.generator.api.om
 */
abstract class BaseDepartmentmember extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DepartmentmemberPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DepartmentmemberPeer
     */
    ...
    /**
     * The value for the iddepartmentmember field.
     * @var        int
     */
    protected $iddepartmentmember;
    ...
    /**
     * Get the [iddepartmentmember] column value.
     *
     * @return int
     */
    public function getIddepartmentmember()
    {
    ...
    /**
     * Set the value of [iddepartmentmember] column.
     *
     * @param  int $v new value
     * @return Departmentmember The current object (for fluent API support)
     */
    public function setIddepartmentmember($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->iddepartmentmember !== $v) {
            $this->iddepartmentmember = $v;
            $this->modifiedColumns[] = DepartmentmemberPeer::IDDEPARTMENTMEMBER;
        }


        return $this;
    } // setIddepartmentmember()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->iddepartmentmember = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = DepartmentmemberPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Departmentmember object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DepartmentmemberPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DepartmentmemberQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DepartmentmemberPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = DepartmentmemberPeer::IDDEPARTMENTMEMBER;
        if (null !== $this->iddepartmentmember) {
        ...
        if ($this->isColumnModified(DepartmentmemberPeer::IDDEPARTMENTMEMBER)) {
            $modifiedColumns[':p' . $index++]  = '`iddepartmentmember`';
        }
        if ($this->isColumnModified(DepartmentmemberPeer::IDDEPARTMENT)) {
            $modifiedColumns[':p' . $index++]  = '`iddepartment`';
        }
        if ($this->isColumnModified(DepartmentmemberPeer::IDUSER)) {
            $modifiedColumns[':p' . $index++]  = '`iduser`';
        }

        $sql = sprintf(
            'INSERT INTO `departmentmember` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`iddepartmentmember`':
                        $stmt->bindValue($identifier, $this->iddepartmentmember, PDO::PARAM_INT);
                        break;
                    case '`iddepartment`':
    ...
    {
        $pos = DepartmentmemberPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIddepartmentmember();
                break;
            case 1:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Departmentmember'][$this->getPrimaryKey()] = true;
        $keys = DepartmentmemberPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIddepartmentmember(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIddepartmentmember($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIddepartmentmember($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartmentmemberPeer::IDDEPARTMENTMEMBER)) $criteria->add(DepartmentmemberPeer::IDDEPARTMENTMEMBER, $this->iddepartmentmember);
        if ($this->isColumnModified(DepartmentmemberPeer::IDDEPARTMENT)) $criteria->add(DepartmentmemberPeer::IDDEPARTMENT, $this->iddepartment);
        if ($this->isColumnModified(DepartmentmemberPeer::IDUSER)) $criteria->add(DepartmentmemberPeer::IDUSER, $this->iduser);
    ...
    {
        $criteria = new Criteria(DepartmentmemberPeer::DATABASE_NAME);
        $criteria->add(DepartmentmemberPeer::IDDEPARTMENTMEMBER, $this->iddepartmentmember);
    ...
    /**
     * Generic method to set the primary key (iddepartmentmember column).
     *
    ...
    {
        $this->setIddepartmentmember($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIddepartmentmember();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Departmentmember (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Departmentmember Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DepartmentmemberPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DepartmentmemberPeer();
        }
    ...
    {
        return (string) $this->exportTo(DepartmentmemberPeer::DEFAULT_STRING_FORMAT);
    }
