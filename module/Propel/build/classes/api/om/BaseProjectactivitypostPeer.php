...
abstract class BaseProjectactivitypostPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idprojectactivitypost', 'Idprojectactivity', 'Iduser', 'ProjectactivitypostText', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idprojectactivitypost', 'idprojectactivity', 'iduser', 'projectactivitypostText', ),
        BasePeer::TYPE_COLNAME => array (ProjectactivitypostPeer::IDPROJECTACTIVITYPOST, ProjectactivitypostPeer::IDPROJECTACTIVITY, ProjectactivitypostPeer::IDUSER, ProjectactivitypostPeer::PROJECTACTIVITYPOST_TEXT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPROJECTACTIVITYPOST', 'IDPROJECTACTIVITY', 'IDUSER', 'PROJECTACTIVITYPOST_TEXT', ),
        BasePeer::TYPE_FIELDNAME => array ('idprojectactivitypost', 'idprojectactivity', 'iduser', 'projectactivitypost_text', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idprojectactivitypost' => 0, 'Idprojectactivity' => 1, 'Iduser' => 2, 'ProjectactivitypostText' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idprojectactivitypost' => 0, 'idprojectactivity' => 1, 'iduser' => 2, 'projectactivitypostText' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProjectactivitypostPeer::IDPROJECTACTIVITYPOST => 0, ProjectactivitypostPeer::IDPROJECTACTIVITY => 1, ProjectactivitypostPeer::IDUSER => 2, ProjectactivitypostPeer::PROJECTACTIVITYPOST_TEXT => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPROJECTACTIVITYPOST' => 0, 'IDPROJECTACTIVITY' => 1, 'IDUSER' => 2, 'PROJECTACTIVITYPOST_TEXT' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('idprojectactivitypost' => 0, 'idprojectactivity' => 1, 'iduser' => 2, 'projectactivitypost_text' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Projectactivitypost) to the collection in $obj3 (Projectactivity)
