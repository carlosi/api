...
/**
 * Base static class for performing query and update operations on the 'projectactivityuser' table.
 *
 *
 *
 * @package propel.generator.api.om
 */
abstract class BaseProjectactivityuserPeer
{
    ...
    const TABLE_NAME = 'projectactivityuser';

    /** the related Propel class for this table */
    const OM_CLASS = 'Projectactivityuser';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ProjectactivityuserTableMap';
    ...
    const IDPROJECTACTIVITY = 'projectactivityuser.idprojectactivity';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Projectactivityuser objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array Projectactivityuser[]
     */
    ...
    {
        $toNames = ProjectactivityuserPeer::getFieldNames($toType);
        $key = isset(ProjectactivityuserPeer::$fieldKeys[$fromType][$name]) ? ProjectactivityuserPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ProjectactivityuserPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ProjectactivityuserPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ProjectactivityuserPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. ProjectactivityuserPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(ProjectactivityuserPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ProjectactivityuserPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = ProjectactivityuserPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return ProjectactivityuserPeer::populateObjects(ProjectactivityuserPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param Projectactivityuser $obj A Projectactivityuser object.
     ...
     *
     * @param      mixed $value A Projectactivityuser object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Projectactivityuser) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Projectactivityuser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(ProjectactivityuserPeer::$instances[$key]);
        }
     ...
     * @return Projectactivityuser Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ProjectactivityuserPeer::$instances[$key])) {
                return ProjectactivityuserPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (ProjectactivityuserPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        ProjectactivityuserPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to projectactivityuser
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = ProjectactivityuserPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = ProjectactivityuserPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                ProjectactivityuserPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Projectactivityuser object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = ProjectactivityuserPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = ProjectactivityuserPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + ProjectactivityuserPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ProjectactivityuserPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of Projectactivityuser objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Projectactivityuser) to $obj2 (User)
    ...
    /**
     * Selects a collection of Projectactivityuser objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Projectactivityuser objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(ProjectactivityuserPeer::DATABASE_NAME)->getTable(ProjectactivityuserPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseProjectactivityuserPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseProjectactivityuserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \ProjectactivityuserTableMap());
      }
    }
    ...
    {
        return ProjectactivityuserPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Projectactivityuser or Criteria object.
     *
     * @param      mixed $values Criteria or Projectactivityuser object containing data that is used to create the INSERT statement.
    ...
    {
        if ($con === null) {
            $con = Propel::getConnection(ProjectactivityuserPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }
    ...
    /**
     * Performs an UPDATE on the database, given a Projectactivityuser or Criteria object.
     *
     * @param      mixed $values Criteria or Projectactivityuser object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ProjectactivityuserPeer::DATABASE_NAME);
        ...
        } else { // $values is Projectactivityuser object
    ...
    /**
     * Deletes all rows from the projectactivityuser table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(ProjectactivityuserPeer::TABLE_NAME, $con, ProjectactivityuserPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            ProjectactivityuserPeer::clearInstancePool();
            ProjectactivityuserPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a Projectactivityuser or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or Projectactivityuser object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Projectactivityuser) { // it's a model object
            // invalidate the cache for this single object
            ProjectactivityuserPeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given Projectactivityuser object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param Projectactivityuser $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(ProjectactivityuserPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(ProjectactivityuserPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(ProjectactivityuserPeer::DATABASE_NAME, ProjectactivityuserPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = ProjectactivityuserPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
...
} // BaseProjectactivityuserPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseProjectactivityuserPeer::buildTableMap();
