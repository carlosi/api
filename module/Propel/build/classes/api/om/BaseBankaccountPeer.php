...
/**
 * Base static class for performing query and update operations on the 'bankaccount' table.
 *
 *
 *
...
abstract class BaseBankaccountPeer
{
    ...
    const IDBANKACCOUNT = 'bankaccount.idbankaccount';

    /** the column name for the idcompany field */
    const IDCOMPANY = 'bankaccount.idcompany';

    /** the column name for the bankaccount_name field */
    const BANKACCOUNT_NAME = 'bankaccount.bankaccount_name';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idbankaccount', 'Idcompany', 'BankaccountName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idbankaccount', 'idcompany', 'bankaccountName', ),
        BasePeer::TYPE_COLNAME => array (BankaccountPeer::IDBANKACCOUNT, BankaccountPeer::IDCOMPANY, BankaccountPeer::BANKACCOUNT_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDBANKACCOUNT', 'IDCOMPANY', 'BANKACCOUNT_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('idbankaccount', 'idcompany', 'bankaccount_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idbankaccount' => 0, 'Idcompany' => 1, 'BankaccountName' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idbankaccount' => 0, 'idcompany' => 1, 'bankaccountName' => 2, ),
        BasePeer::TYPE_COLNAME => array (BankaccountPeer::IDBANKACCOUNT => 0, BankaccountPeer::IDCOMPANY => 1, BankaccountPeer::BANKACCOUNT_NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDBANKACCOUNT' => 0, 'IDCOMPANY' => 1, 'BANKACCOUNT_NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idbankaccount' => 0, 'idcompany' => 1, 'bankaccount_name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BankaccountPeer::IDBANKACCOUNT);
            $criteria->addSelectColumn(BankaccountPeer::IDCOMPANY);
            $criteria->addSelectColumn(BankaccountPeer::BANKACCOUNT_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.idbankaccount');
            $criteria->addSelectColumn($alias . '.idcompany');
            $criteria->addSelectColumn($alias . '.bankaccount_name');
        }
    }
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdbankaccount();
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Bankaccount) {
                $key = (string) $value->getIdbankaccount();
    ...
    /**
     * Method to invalidate the instance pool of all tables related to bankaccount
    ...
    public static function doCountJoinCompany(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BankaccountPeer::IDCOMPANY, CompanyPeer::IDCOMPANY, $join_behavior);
    ...
    /**
     * Selects a collection of Bankaccount objects pre-filled with their Company objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCompany(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Bankaccount) to $obj2 (Company)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Bankaccount) to the collection in $obj2 (Company)
                $obj2->addBankaccount($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(BankaccountPeer::IDBANKACCOUNT) && $criteria->keyContainsValue(BankaccountPeer::IDBANKACCOUNT) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(BankaccountPeer::IDBANKACCOUNT);
            $value = $criteria->remove(BankaccountPeer::IDBANKACCOUNT);
            if ($value) {
                $selectCriteria->add(BankaccountPeer::IDBANKACCOUNT, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the bankaccount table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BankaccountPeer::doOnDeleteCascade(new Criteria(BankaccountPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(BankaccountPeer::IDBANKACCOUNT, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += BankaccountPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(BankordertransactionPeer::IDBANKACCOUNT, $obj->getIdbankaccount());
            $affectedRows += BankordertransactionPeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(BankaccountPeer::DATABASE_NAME);
        $criteria->add(BankaccountPeer::IDBANKACCOUNT, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(BankaccountPeer::DATABASE_NAME);
            $criteria->add(BankaccountPeer::IDBANKACCOUNT, $pks, Criteria::IN);
