...
abstract class BaseTokenPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idtoken', 'Iduser', 'Token', 'CreatedAt', 'ExpiresIn', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idtoken', 'iduser', 'token', 'createdAt', 'expiresIn', ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::IDTOKEN, TokenPeer::IDUSER, TokenPeer::TOKEN, TokenPeer::CREATED_AT, TokenPeer::EXPIRES_IN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDTOKEN', 'IDUSER', 'TOKEN', 'CREATED_AT', 'EXPIRES_IN', ),
        BasePeer::TYPE_FIELDNAME => array ('idtoken', 'iduser', 'token', 'created_at', 'expires_in', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idtoken' => 0, 'Iduser' => 1, 'Token' => 2, 'CreatedAt' => 3, 'ExpiresIn' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idtoken' => 0, 'iduser' => 1, 'token' => 2, 'createdAt' => 3, 'expiresIn' => 4, ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::IDTOKEN => 0, TokenPeer::IDUSER => 1, TokenPeer::TOKEN => 2, TokenPeer::CREATED_AT => 3, TokenPeer::EXPIRES_IN => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDTOKEN' => 0, 'IDUSER' => 1, 'TOKEN' => 2, 'CREATED_AT' => 3, 'EXPIRES_IN' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('idtoken' => 0, 'iduser' => 1, 'token' => 2, 'created_at' => 3, 'expires_in' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TokenPeer::IDTOKEN);
            $criteria->addSelectColumn(TokenPeer::IDUSER);
            $criteria->addSelectColumn(TokenPeer::TOKEN);
            $criteria->addSelectColumn(TokenPeer::CREATED_AT);
            $criteria->addSelectColumn(TokenPeer::EXPIRES_IN);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TokenPeer::IDUSER, UserPeer::IDUSER, $join_behavior);
    ...
    /**
     * Selects a collection of Token objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Token) to $obj2 (User)
                $obj2->addToken($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Token) to the collection in $obj2 (User)
                $obj2->addToken($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(TokenPeer::IDTOKEN) && $criteria->keyContainsValue(TokenPeer::IDTOKEN) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TokenPeer::IDTOKEN.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(TokenPeer::IDTOKEN);
            $value = $criteria->remove(TokenPeer::IDTOKEN);
            if ($value) {
                $selectCriteria->add(TokenPeer::IDTOKEN, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TokenPeer::IDTOKEN, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(TokenPeer::DATABASE_NAME);
        $criteria->add(TokenPeer::IDTOKEN, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(TokenPeer::DATABASE_NAME);
            $criteria->add(TokenPeer::IDTOKEN, $pks, Criteria::IN);
