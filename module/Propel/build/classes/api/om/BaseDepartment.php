...
abstract class BaseDepartment extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the department_type field.
    ...
    /**
     * Get the [department_type] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [department_type] column.
     *
     * @param  string $v new value
     * @return Department The current object (for fluent API support)
     */
    public function setDepartmentType($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->department_type !== $v) {
            $this->department_type = $v;
            $this->modifiedColumns[] = DepartmentPeer::DEPARTMENT_TYPE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DepartmentPeer::DEPARTMENT_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`department_type`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`department_type`':
                        $stmt->bindValue($identifier, $this->department_type, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function setBranchdepartments(PropelCollection $branchdepartments, PropelPDO $con = null)
    {
        ...
        foreach ($branchdepartmentsToDelete as $branchdepartmentRemoved) {
            $branchdepartmentRemoved->setDepartment(null);
        }
    ...
    protected function doAddBranchdepartment($branchdepartment)
    {
        ...
        $branchdepartment->setDepartment($this);
    }
    ...
    public function removeBranchdepartment($branchdepartment)
    {
        if ($this->getBranchdepartments()->contains($branchdepartment)) {
            ...
            $branchdepartment->setDepartment(null);
        }
     ...
     * @return PropelObjectCollection|Branchdepartment[] List of Branchdepartment objects
     */
    public function getBranchdepartmentsJoinBranch($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BranchdepartmentQuery::create(null, $criteria);
