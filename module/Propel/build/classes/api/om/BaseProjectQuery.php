 ...
 * @method ProjectQuery orderByIddepartment($order = Criteria::ASC) Order by the iddepartment column
 ...
 * @method ProjectQuery orderByProjectStartdate($order = Criteria::ASC) Order by the project_startdate column
 * @method ProjectQuery orderByProjectEnddate($order = Criteria::ASC) Order by the project_enddate column
 *
 * @method ProjectQuery groupByIdproject() Group by the idproject column
 * @method ProjectQuery groupByIddepartment() Group by the iddepartment column
 ...
 * @method ProjectQuery groupByProjectStartdate() Group by the project_startdate column
 * @method ProjectQuery groupByProjectEnddate() Group by the project_enddate column
 *
 ...
 *
 * @method Project findOneByIddepartment(int $iddepartment) Return the first Project filtered by the iddepartment column
 ...
 * @method Project findOneByProjectStartdate(string $project_startdate) Return the first Project filtered by the project_startdate column
 * @method Project findOneByProjectEnddate(string $project_enddate) Return the first Project filtered by the project_enddate column
 *
 * @method array findByIdproject(int $idproject) Return Project objects filtered by the idproject column
 * @method array findByIddepartment(int $iddepartment) Return Project objects filtered by the iddepartment column
 ...
 * @method array findByProjectStartdate(string $project_startdate) Return Project objects filtered by the project_startdate column
 * @method array findByProjectEnddate(string $project_enddate) Return Project objects filtered by the project_enddate column
 *
...
abstract class BaseProjectQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `idproject`, `iddepartment`, `project_dependency`, `project_name`, `project_startdate`, `project_enddate` FROM `project` WHERE `idproject` = :p0';
        try {
    ...
    public function filterByIddepartment($iddepartment = null, $comparison = null)
    {
        if (is_array($iddepartment)) {
            ...
            if (isset($iddepartment['min'])) {
                $this->addUsingAlias(ProjectPeer::IDDEPARTMENT, $iddepartment['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($iddepartment['max'])) {
                $this->addUsingAlias(ProjectPeer::IDDEPARTMENT, $iddepartment['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectPeer::IDDEPARTMENT, $iddepartment, $comparison);
    }
    ...
    /**
     * Filter the query on the project_startdate column
     *
     * Example usage:
     * <code>
     * $query->filterByProjectStartdate('2011-03-14'); // WHERE project_startdate = '2011-03-14'
     * $query->filterByProjectStartdate('now'); // WHERE project_startdate = '2011-03-14'
     * $query->filterByProjectStartdate(array('max' => 'yesterday')); // WHERE project_startdate < '2011-03-13'
     * </code>
     *
     * @param     mixed $projectStartdate The value to use as filter.
     ...
     * @return ProjectQuery The current query, for fluid interface
     */
    public function filterByProjectStartdate($projectStartdate = null, $comparison = null)
    {
        if (is_array($projectStartdate)) {
            $useMinMax = false;
            if (isset($projectStartdate['min'])) {
                $this->addUsingAlias(ProjectPeer::PROJECT_STARTDATE, $projectStartdate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($projectStartdate['max'])) {
                $this->addUsingAlias(ProjectPeer::PROJECT_STARTDATE, $projectStartdate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectPeer::PROJECT_STARTDATE, $projectStartdate, $comparison);
    }

    /**
     * Filter the query on the project_enddate column
     *
     * Example usage:
     * <code>
     * $query->filterByProjectEnddate('2011-03-14'); // WHERE project_enddate = '2011-03-14'
     * $query->filterByProjectEnddate('now'); // WHERE project_enddate = '2011-03-14'
     * $query->filterByProjectEnddate(array('max' => 'yesterday')); // WHERE project_enddate < '2011-03-13'
     * </code>
     *
     * @param     mixed $projectEnddate The value to use as filter.
     *              Values can be integers (unix timestamps), DateTime objects, or strings.
     *              Empty strings are treated as NULL.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     ...
     * @return ProjectQuery The current query, for fluid interface
     */
    public function filterByProjectEnddate($projectEnddate = null, $comparison = null)
    {
        if (is_array($projectEnddate)) {
            $useMinMax = false;
            if (isset($projectEnddate['min'])) {
                $this->addUsingAlias(ProjectPeer::PROJECT_ENDDATE, $projectEnddate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($projectEnddate['max'])) {
                $this->addUsingAlias(ProjectPeer::PROJECT_ENDDATE, $projectEnddate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectPeer::PROJECT_ENDDATE, $projectEnddate, $comparison);
    }
    ...
    public function filterByDepartment($department, $comparison = null)
    {
        if ($department instanceof Department) {
            return $this
                ->addUsingAlias(ProjectPeer::IDDEPARTMENT, $department->getIddepartment(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProjectPeer::IDDEPARTMENT, $department->toKeyValue('PrimaryKey', 'Iddepartment'), $comparison);
        } else {
