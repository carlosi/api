...
abstract class BaseProductPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct', 'Idproductmain', 'ProductStatus', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct', 'idproductmain', 'productStatus', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT, ProductPeer::IDPRODUCTMAIN, ProductPeer::PRODUCT_STATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT', 'IDPRODUCTMAIN', 'PRODUCT_STATUS', ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct', 'idproductmain', 'product_status', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct' => 0, 'Idproductmain' => 1, 'ProductStatus' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct' => 0, 'idproductmain' => 1, 'productStatus' => 2, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT => 0, ProductPeer::IDPRODUCTMAIN => 1, ProductPeer::PRODUCT_STATUS => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT' => 0, 'IDPRODUCTMAIN' => 1, 'PRODUCT_STATUS' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct' => 0, 'idproductmain' => 1, 'product_status' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(QuoteitemPeer::IDPRODUCT, $obj->getIdproduct());
