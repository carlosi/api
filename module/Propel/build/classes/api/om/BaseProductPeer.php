...
abstract class BaseProductPeer
{
    ...
    const IDPRODUCTMAIN = 'product.idproductmain';

    /** the column name for the property_array field */
    const PROPERTY_ARRAY = 'product.property_array';

    /** the column name for the product_status field */
    const PRODUCT_STATUS = 'product.product_status';

    /** The enumerated values for the product_status field */
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct', 'Idproductmain', 'PropertyArray', 'ProductStatus', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct', 'idproductmain', 'propertyArray', 'productStatus', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT, ProductPeer::IDPRODUCTMAIN, ProductPeer::PROPERTY_ARRAY, ProductPeer::PRODUCT_STATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT', 'IDPRODUCTMAIN', 'PROPERTY_ARRAY', 'PRODUCT_STATUS', ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct', 'idproductmain', 'property_array', 'product_status', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct' => 0, 'Idproductmain' => 1, 'PropertyArray' => 2, 'ProductStatus' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct' => 0, 'idproductmain' => 1, 'propertyArray' => 2, 'productStatus' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT => 0, ProductPeer::IDPRODUCTMAIN => 1, ProductPeer::PROPERTY_ARRAY => 2, ProductPeer::PRODUCT_STATUS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT' => 0, 'IDPRODUCTMAIN' => 1, 'PROPERTY_ARRAY' => 2, 'PRODUCT_STATUS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct' => 0, 'idproductmain' => 1, 'property_array' => 2, 'product_status' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
        ProductPeer::PRODUCT_STATUS => array(
            ProductPeer::PRODUCT_STATUS_ACTIVE,
            ProductPeer::PRODUCT_STATUS_INACTIVE,
        ),
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductPeer::IDPRODUCTMAIN);
            $criteria->addSelectColumn(ProductPeer::PROPERTY_ARRAY);
            $criteria->addSelectColumn(ProductPeer::PRODUCT_STATUS);
        } else {
            $criteria->addSelectColumn($alias . '.idproduct');
            $criteria->addSelectColumn($alias . '.idproductmain');
            $criteria->addSelectColumn($alias . '.property_array');
    ...
    public static function doCountJoinProductmain(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProductPeer::IDPRODUCTMAIN, ProductmainPeer::IDPRODUCTMAIN, $join_behavior);
    ...
    /**
     * Selects a collection of Product objects pre-filled with their Productmain objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProductmain(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Product) to $obj2 (Productmain)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Product) to the collection in $obj2 (Productmain)
                $obj2->addProduct($obj1);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ProductpropertyPeer::IDPRODUCT, $obj->getIdproduct());
