...
class DepartmentTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('departament_name', 'DepartamentName', 'VARCHAR', true, 245, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Departamentmember', 'Departamentmember', RelationMap::ONE_TO_MANY, array('iddepartment' => 'iddepartament', ), 'CASCADE', 'CASCADE', 'Departamentmembers');
        $this->addRelation('Project', 'Project', RelationMap::ONE_TO_MANY, array('iddepartment' => 'iddepartament', ), 'CASCADE', 'CASCADE', 'Projects');
    } // buildRelations()
