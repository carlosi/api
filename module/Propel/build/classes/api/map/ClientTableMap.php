...
class ClientTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('client_firstname', 'ClientFirstname', 'VARCHAR', true, 245, null);
        $this->addColumn('client_lastname', 'ClientLastname', 'VARCHAR', true, 145, null);
  ...
  2 => 'inventorymanager',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Clientaddressship', 'Clientaddressship', RelationMap::ONE_TO_MANY, array('idclient' => 'idclient', ), 'CASCADE', 'CASCADE', 'Clientaddressships');
        ...
        $this->addRelation('Triggerprospection', 'Triggerprospection', RelationMap::ONE_TO_MANY, array('idclient' => 'idclient', ), 'CASCADE', 'CASCADE', 'Triggerprospections');
    } // buildRelations()
